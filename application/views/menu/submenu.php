                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="#" data-toggle="modal" data-target="#modalEditSubMenu<?= $sm['id']; ?>" class="badge
...
<!-- Modal -->
<div class="modal fade" id="newSubmenuModal" tabindex="-1" role="dialog" arial-labelledby="newSubmenuModalLabel" aria-hidden="true">
